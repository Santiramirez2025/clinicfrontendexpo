...
// src/styles/typography.ts - Agregar al final del archivo
export const modernTypography = {
  ...typography,
  headingLarge: { fontSize: 28, fontWeight: '700' as const },
  headingMedium: { fontSize: 24, fontWeight: '700' as const },
  headingSmall: { fontSize: 20, fontWeight: '600' as const },
